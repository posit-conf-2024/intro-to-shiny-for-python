...
include_shiny_folder(
    # "../apps/core/1-getting-started/1.10-add-plot",
    "./exercises/express-04-plot/1.7-add-plot",
...
<!-- TODO: Revert to original example to reflect the reactive graph -->
...
{{< yourturn 'express-05-reactive-effect' 'true' >}}
...
{{< yourturn 'express-05-reactive-event' 'true' >}}
...
{{< yourturn 'express-13-reactivity' 'true' >}}
