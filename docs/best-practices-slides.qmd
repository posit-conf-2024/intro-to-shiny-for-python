...
Go to [exercises/13-ui-functions](../exercises/13-ui-functions.html) or run problems `5.1` and `5.2` in `apps/core/exercises/5-workflows`.
...
Go to [exercises/14-extract-functions](../exercises/14-extract-functions.html) or run problem `5.3` in `apps/core/exercises/5-workflows`.
