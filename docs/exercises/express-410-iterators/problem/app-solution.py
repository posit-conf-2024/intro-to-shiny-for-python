...
# Define the data structure for value boxes
value_boxes = [
    ...
    with ui.navset_tab():        
        with ui.nav_panel("Error"):
            with ui.layout_columns():
                ...
                # Loop over the value boxes and pass the information to the value_box_module function
                for box in value_boxes:
                    value_box_module(box["id"], box["title"], box["value"])
