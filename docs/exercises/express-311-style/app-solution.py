...
with ui.sidebar(class_="bg-secondary-subtle text-dark"):
...
with ui.navset_tab():
    with ui.nav_panel("Error"):    
        with ui.layout_columns(
            ...
            with ui.card():
                ui.card_header("Distribution", class_="bg-secondary-subtle text-dark"),
                @render.plot
                def error_distribution():
                    return plots.temp_distribution(filtered_data())
                
            with ui.card():
                ui.card_header("Error by day", class_="bg-secondary-subtle text-dark"),
                @render.plot
                def error_by_day():
