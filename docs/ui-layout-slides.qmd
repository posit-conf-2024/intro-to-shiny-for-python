...
{{< yourview '310-target-app' >}}

## Where we're starting

{{< yourview '311-starting-app' >}}
...
{{< yourview '312-value-boxes' >}}

::: {.callout-tip}
The `faicons` package provides [fontawesome](https://fontawesome.com/) icons.
:::

## Your turn

{{< yourturn 'express-303-value-boxes' >}}
...
- Enter `ui.layout_coilumns()`

## `ui.layout_columns()`

{{< yourview '313-columns' >}}
...
Use `ui.navset_bar()` to organize nav_panels into a multipage app.
