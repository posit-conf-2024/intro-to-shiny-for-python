...
{{< yourturn 'express-105-reactivity' >}}
...
{{< yourturn 'express-108-debug' >}}

## Your turn

{{< yourturn 'express-109-debug' >}}
...
3.  Tell Shiny how to use inputs to build outputs
